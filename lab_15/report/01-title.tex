\begin{titlepage}
    ...
    {\LARGE\scshape\bfseries
        Лабораторная работа \textnumero15
    }
    ...
    \begin{flushleft}
        ...
        \begin{tabular}{l@{\hspace{1cm}}l}
            \textbf{Дисциплина} & \uline{\hfill{}Функциональное и\hfill}\\&\uline{\quad{}логическое программирование\quad\hfill} \\
            \textbf{Тема} & \uline{\quad{}Структура программы на Prolog\hfill}\\&\uline{\quad{}и ее реализация\quad\hfill} \\
            \textbf{Студент} & \uline{\quad{}Набиев~Ф.М.\quad\hfill} \\
            \textbf{Группа} & \uline{\quad{}ИУ7--63Б\quad\hfill} \\
            \textbf{Преподаватель} & \uline{\quad{}Толпинская~Н.Б., Строганов~Ю.В.\quad\hfill} \\
        \end{tabular}
